...
If You want to build a website with Joomla at short time;

#### Full stack Nginx Joomla:
<p align="left">
<a href="https://www.joomla.org/" target="_blank" rel="noreferrer"> <img src="https://avatars.githubusercontent.com/u/69416061?s=200&v=4" alt="Joomla" height="40" width="40"/> </a>&nbsp;&nbsp;&nbsp; 
...
|```JOOMLA_DB_USER```|```JOOMLA_DB_PASSWORD```|```JOOMLA_DB_NAME```|```MYSQL_ROOT_PASSWORD```|```DATABASE_IMAGE_NAME```|
...
The containers are now built and running. You should be able to access the Joomla installation with the configured IP in the browser address. `https://DOMAIN_NAME`.
